...
export default function CardTour () {
  return (
    <div className="relative h-auto w-auto overflow-hidden rounded-xl border border-gray-300 p-[1px] backdrop-blur-3xl">
        ...
        <div className="flex flex-col h-full w-full items-center justify-center rounded-xl bg-gray-300 text-sm xl:text-base font-semibold backdrop-blur-3xl">
            ...
            <div className="p-5 w-full">
                <h3 className="mb-2 text-xl xl:text-2xl font-bold tracking-tight text-gray-900">
                    Bodega Flecha de los Andes
                </h3>
                <p className="mb-3 text-gray-800 line-clamp-5 text-pretty">
                ...
                <a href="#" className="inline-flex items-center px-3 py-2 text-center text-base xl:text-lg text-gray-300 rounded-lg bg-purple-950 transition hover:scale-105 hover:text-gray-200">
                    Vea Más
