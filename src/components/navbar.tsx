      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="md:flex items-center justify-between hidden" id="navbar-language">
          <ul className="flex flex-col md:flex-row text-xl font-medium p-4 md:p-0 mt-4 md:space-x-8 md:mt-0">
            ...
            <li>
              <a href="#" className="block py-2 px-3 md:p-0 transition hover:text-amber-600 hover:font-semibold">Contact</a>
            </li>
          </ul>
        </div>

        <div className="flex items-center">
            <button type="button" className="inline-flex items-center font-medium justify-center px-4 py-2 text-xl transition hover:bg-slate-300 hover:text-fuchsia-950 rounded-xl">
