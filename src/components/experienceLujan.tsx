...
const toursLujan: any[] = [
  ...
  {
    title: 'Bodega Kaiken',
    introduction: 'Ubicada en Vistalba, Luján de Cuyo. Ofrece visitas guiadas y degustaciones, permitiendo a los visitantes conocer el proceso de elaboracion de Vinos; y cuenta de experiencias gastronómicas en la bodega, donde se maridan los vinos con platos locales y gourmet. Su arquitectura moderna y funcional, diseñada para optimizar el proceso de vinificación. Construcción integrada con el paisaje, utilizando materiales locales y sostenibles. Especializada en Malbec, Cabernet Sauvignon, Bonarda y Chardonnay, las líneas de vinos incluyen Kaiken Ultra, Kaiken Terroir Series, Kaiken Obertura y Kaiken Mai, con un enfoque en la calidad y la expresión del terroir.',
    image: '/experiencesLujan/Bodega-Kaiken.webp',
    description: 'Viñedos ubicados en Vistalba, Agrelo (Luján de Cuyo) y el Valle de Uco. A altitudes que van desde los 950 y 1,200 metros sobre el nivel del mar, aprovechando el clima seco y los suelos diversos para cultivar uvas de alta calidad. La Bodega ha sido reconocida con premios como "Decanter World Wine Awards": Medallas de oro y plata para varios de sus vinos, destacándose Kaiken Ultra Malbec y Kaiken Obertura. "Wine Spectator y Wine Enthusiast": Altas puntuaciones para vinos como Kaiken Malbec y Kaiken Cabernet Sauvignon, que resaltan por su calidad y consistencia. "Tim Atkin": Reconocimientos en sus informes anuales de vinos argentinos, destacando la línea Kaiken Mai por su complejidad y elegancia. "James Suckling": Altas calificaciones para vinos como Kaiken Terroir Series y Kaiken Ultra, con menciones especiales para su estructura y potencial de envejecimiento.'
  }
]
