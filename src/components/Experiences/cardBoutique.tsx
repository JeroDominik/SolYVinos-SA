...
export default function CardBoutique ({ experiencesBoutique }: ExperienceProps) {
  ...
  return (
    <li className="flex items-center justify-center relative w-full mx-auto h-[500px] md:h-80 bg-neutral-900 rounded-md border-2 border-fuchsia-950/30 hover:shadow-[0_0_10px_4px_rgba(74,4,78,0.3)] transition">
      ...
      <div className={`order-2 flex flex-col md:flex-row gap-8 md:items-center justify-center md:justify-between overflow-hidden rounded-lg h-full py-4 ${animateSlide ? 'animate-slideIn' : ''}`}>
        ...
        <div className="flex flex-col w-full md:w-3/5">
          <h3 className="mb-2 text-xl xl:text-2xl font-bold text-center">
